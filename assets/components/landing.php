...
$query = "SELECT p.productId, p.name, p.price, p.stock, p.rate, p.sold, pi.imagePath 
          FROM products p 
...
<div class="row ms-2 me-2 mt-3" id="top-sellers">
            <div class="col-12 ">
                <h2>Top Sellers</h2>
                <div class="scrolling-wrapper row row-cols-1 row-cols-md-5 g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card h-100 text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <!-- <strong>Bio:</strong> <?php echo htmlspecialchars($seller['bio']); ?><br> -->
