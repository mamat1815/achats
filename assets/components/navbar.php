<?php
require_once 'config/config.php'; // Pastikan file koneksi database di-include

// Default foto profil jika img tidak tersedia
$defaultProfile = '../uploads/default-profile.png';
...
// Ambil nama pertama dari fullname di session
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <?php if (isset($_SESSION['userId'])): ?>
        <!-- Jika sudah login, tampilkan foto profil atau nama -->
        <div class="dropdown">
      ...
      <?php else: ?>
        <!-- Jika belum login, tampilkan tombol Login dan Registration -->
